...
DEFAULT_PROJECT_ROOT = "/home/u1120250383/dcs/Emoskill"
DEFAULT_OUTPUT_DIR = "/home/u1120250383/dcs/Emoskill/script_output/fable_skill_v4_batch"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--skills-dir", default=str(Path(__file__).resolve().parent / "skills"))
...
def write_outputs(output_dir: Path, payload: dict[str, Any]) -> tuple[Path, Path]:
    ...
    for item in payload.get("results", []):
        ...
        direct_raw = direct.get("raw_model_output") or {}
        routed_raw = routed.get("raw_model_output") or {}
        ...
        rows.append(
            {
                ...
                "direct_activation_evidence": json.dumps(
                    direct.get("activation_evidence") or [], ensure_ascii=False
                ),
                "direct_arousal_gate": direct_raw.get("_arousal_gate", ""),
                ...
                "skill_activation_evidence": json.dumps(
                    routed.get("activation_evidence") or [], ensure_ascii=False
                ),
                "skill_arousal_gate": routed_raw.get("_arousal_gate", ""),
