...
from psychology_va.pipeline import _validate_va_mapping_payload
...
DEFAULT_OUTPUT_DIR = "/home/u1120250383/dcs/Emoskill/script_output/va_mapping_9skill_batch"
...
def analysis_prompts_for_skill(
    *,
    ...
    analysis_user_prompt = build_analysis_user_prompt(
        ...
        user_context=args.user_context,
        direct_valence_score=getattr(direct_result, "valence_score", None),
        direct_arousal_score=getattr(direct_result, "arousal_score", None),
    )
        ...
        if not args.direct_only:
            ...
            for candidate_index, candidate_skill_id in enumerate(candidate_skill_ids, start=1):
                ...
                try:
                    ...
                    _validate_va_mapping_payload(skill_payload, direct_result)
