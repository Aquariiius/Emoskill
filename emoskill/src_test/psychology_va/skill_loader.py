...
def _build_spec_from_markdown(
    ...
    va_mapping = _section(body, "VA Mapping")
    direct_anchor_rule = _section(body, "Direct-Anchor Rule")
    reasoning_principle = (
        va_mapping
        or _section(body, "VA Judgment")
    ...
    va_focus_parts = [part for part in (reasoning_principle, direct_anchor_rule) if part]
    va_focus = _squash("\n".join(va_focus_parts)) or _squash(purpose) or description
